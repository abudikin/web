...
$string="Функции – вещь довольно простая. Она представляет собой кусок кода, который принимает определенные параметры и на выходе возвращает какой-либо результат";
function TheUpperFirstWord($str){
    ...
    $count = range(1,32);
    $str1 = str_ireplace($Uppers, $count, $str);
    $str1 = str_ireplace($Lows, $count, $str1);
    echo $str1;
}
TheUpperFirstWord($string);
?>